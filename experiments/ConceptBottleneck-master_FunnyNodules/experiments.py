...
def run_experiments(dataset, args):
    ...
    elif dataset == 'FunnyNodules':
        from FunnyNodules.train import (train_X_to_C_to_y)
...
def parse_arguments():
    ...
    assert sys.argv[1] in ['OAI', 'CUB','FunnyNodules'], 'Please specify OAI, CUB, or FunnyNodules dataset'
    ...
    if dataset == 'OAI':
        ...
        from FunnyNodules.train import parse_arguments
